...
export const exampleCspPicksFile: CspPicksFile = {
  ...
  picks: [
    { ticker: "NVDA", strategy: "CSP", contractSymbol: "NVDA  261016P00200000", strike: 200, expiration: isoDay(28), dte: 28, delta: 0.24, premium: 4.1, annualizedRorPct: 27, rank: 1, rationale: "VRP rich; positive net gamma; put wall 200", thetaPerDay: 14.2, iv: 0.63, atmIV: 0.61, vrp: "rich", vrpRatio: 1.42, vrp20: "rich", vrpRatio20: 1.36, ivRank: 81, tier: "S" },
    { ticker: "AMD", strategy: "CSP", contractSymbol: "AMD   261016P00175000", strike: 175, expiration: isoDay(28), dte: 28, delta: 0.22, premium: 3.6, annualizedRorPct: 27, rank: 2, rationale: "VRP rich; above 20-day SMA", thetaPerDay: 12.1, iv: 0.55, atmIV: 0.524, vrp: "rich", vrpRatio: 1.31, vrp20: "rich", vrpRatio20: 1.25, ivRank: 58, tier: "S" },
    { ticker: "COHR", strategy: "CSP_AGGRESSIVE", contractSymbol: "COHR  260925P00285000", strike: 285, expiration: isoDay(7), dte: 7, delta: 0.26, premium: 3.9, annualizedRorPct: 71, rank: 1, rationale: "short-dated; clears the aggressive ARR floor", thetaPerDay: 38.4, iv: 0.7, atmIV: 0.665, vrp: "fair", vrpRatio: 1.08, vrp20: "rich", vrpRatio20: 1.21, ivRank: null, tier: "A" },
    { ticker: "GLW", strategy: "CSP", contractSymbol: "GLW   261016P00140000", strike: 140, expiration: isoDay(28), dte: 28, delta: 0.21, premium: 2.2, annualizedRorPct: 20, rank: 3, rationale: "VRP fair; RSI 48", thetaPerDay: 7.6, iv: 0.39, atmIV: 0.372, vrp: "fair", vrpRatio: 1.04, vrp20: "rich", vrpRatio20: 1.2, ivRank: 34, tier: "A" },
    { ticker: "MU", strategy: "CSP_SAFE", contractSymbol: "MU    261016P00800000", strike: 800, expiration: isoDay(28), dte: 28, delta: 0.14, premium: 9.8, annualizedRorPct: 16, rank: 1, rationale: "20-delta safe band", thetaPerDay: 31.0, iv: 0.6, atmIV: 0.582, vrp: "fair", vrpRatio: 0.97, vrp20: "fair", vrpRatio20: 1.12, ivRank: 47, tier: "A" },
    { ticker: "SOFI", strategy: "CSP", contractSymbol: "SOFI  261016P00016000", strike: 16, expiration: isoDay(28), dte: 28, delta: 0.25, premium: 0.42, annualizedRorPct: 34, rank: 4, rationale: "VRP thin; RSI 30 oversold", thetaPerDay: 1.5, iv: 0.57, atmIV: 0.55, vrp: "thin", vrpRatio: 0.82, vrp20: "thin", vrpRatio20: 0.77, ivRank: 22, tier: "B" },
  ],
};
...
// exampleChartData builds a fake-but-internally-consistent chart for
// whatever ticker was searched, seeded off the symbol's own characters so
// different tickers look distinct from each other rather than an identical
// line just relabeled.
...
// internal/watchlistapi's localhost API can't be reached from a public
...
// VRP mirrors that: PANW's manual add has no IV sample yet, so it reads
// n/a even though its realized vol (from price history) is computable.
export function exampleWatchlistBoard(): WatchlistRow[] {
  return [
    { ticker: "AMD", company: "Advanced Micro Devices Inc", sector: "Semiconductors", category: "wheel", source: "sheet", dayChangePct: 0.0142, currentPrice: 187.42, bollingerUpper: 196.5, bollingerMid: 182.3, bollingerLower: 168.1, rsi14: 61.4, ivRank: 58, ivRankSamples: 142, vrp: "rich", vrpRatio: 1.31, tier: "S", atmIV: 0.524, ivAsOf: "2026-09-11", realizedVolBlend: 0.40, realizedVol20: 0.42, vrp20: "rich", vrpRatio20: 1.25, macdLine: 2.1, macdSignal: 1.6, macdHistogram: 0.5, callWall: 195.0, putWall: 175.0, beta: 1.92, ytdPct: 0.842, listedThisYear: false },
    { ticker: "NVDA", company: "NVIDIA Corp", sector: "AI / Semiconductors", category: "wheel", source: "sheet", dayChangePct: 0.0268, currentPrice: 219.74, bollingerUpper: 236.9, bollingerMid: 214.2, bollingerLower: 191.5, rsi14: 72.8, ivRank: 81, ivRankSamples: 210, vrp: "rich", vrpRatio: 1.42, tier: "S", atmIV: 0.61, ivAsOf: "2026-09-11", realizedVolBlend: 0.43, realizedVol20: 0.45, vrp20: "rich", vrpRatio20: 1.36, macdLine: 3.4, macdSignal: 2.2, macdHistogram: 1.2, callWall: 230.0, putWall: 200.0, beta: 1.78, ytdPct: 0.176, listedThisYear: false },
    { ticker: "GLW", company: "Corning Inc", sector: "Materials - Glass & Fiberoptics", category: "wheel", source: "sheet", dayChangePct: -0.0091, currentPrice: 154.3, bollingerUpper: 162.4, bollingerMid: 148.1, bollingerLower: 133.8, rsi14: 48.2, ivRank: 34, ivRankSamples: 96, vrp: "fair", vrpRatio: 1.04, tier: "A", atmIV: 0.372, ivAsOf: "2026-09-11", realizedVolBlend: 0.358, realizedVol20: 0.31, vrp20: "rich", vrpRatio20: 1.2, macdLine: 0.8, macdSignal: 1.1, macdHistogram: -0.3, callWall: 160.0, putWall: 145.0, beta: 1.08, ytdPct: 0.512, listedThisYear: false },
    { ticker: "SOFI", company: "SoFi Technologies Inc", sector: "Financials", category: "wheel", source: "sheet", dayChangePct: -0.0233, currentPrice: 17.66, bollingerUpper: 19.8, bollingerMid: 17.9, bollingerLower: 16.0, rsi14: 29.6, ivRank: 22, ivRankSamples: 88, vrp: "thin", vrpRatio: 0.82, tier: "B", atmIV: 0.55, ivAsOf: "2026-09-11", realizedVolBlend: 0.671, realizedVol20: 0.71, vrp20: "thin", vrpRatio20: 0.77, macdLine: -0.15, macdSignal: -0.05, macdHistogram: -0.1, callWall: 19.0, putWall: 16.0, beta: 1.71, ytdPct: -0.214, listedThisYear: false },
    { ticker: "MU", company: "Micron Technology Inc", sector: "Semiconductors", category: "wheel", source: "sheet", dayChangePct: 0.0317, currentPrice: 940.76, bollingerUpper: 1010.0, bollingerMid: 880.0, bollingerLower: 750.0, rsi14: 66.1, ivRank: 47, ivRankSamples: 175, vrp: "fair", vrpRatio: 0.97, tier: "A", atmIV: 0.582, ivAsOf: "2026-09-11", realizedVolBlend: 0.60, realizedVol20: 0.52, vrp20: "fair", vrpRatio20: 1.12, macdLine: 12.4, macdSignal: 9.8, macdHistogram: 2.6, callWall: 980.0, putWall: 900.0, beta: 1.64, ytdPct: 1.95, listedThisYear: false },
    { ticker: "BRK.B", company: "Berkshire Hathaway Inc Class B", sector: "Conglomerate", category: "safe_haven", source: "sheet", dayChangePct: -0.0018, currentPrice: 502.96, bollingerUpper: 512.0, bollingerMid: 499.0, bollingerLower: 486.0, rsi14: 52.9, ivRank: 12, ivRankSamples: 130, vrp: "rich", vrpRatio: 1.25, tier: "S", atmIV: 0.20, ivAsOf: "2026-09-11", realizedVolBlend: 0.16, realizedVol20: 0.15, vrp20: "rich", vrpRatio20: 1.33, macdLine: 0.9, macdSignal: 1.0, macdHistogram: -0.1, callWall: 510.0, putWall: 495.0, beta: 0.56, ytdPct: 0.061, listedThisYear: false },
    { ticker: "COHR", company: "Coherent Corp", sector: "Photonics - Semiconductor", category: "wheel", source: "sheet", dayChangePct: 0.0124, currentPrice: 306.43, bollingerUpper: 330.0, bollingerMid: 295.0, bollingerLower: 260.0, rsi14: 55.7, ivRank: null, ivRankSamples: 9, vrp: "fair", vrpRatio: 1.08, tier: "A", atmIV: 0.665, ivAsOf: "2026-09-11", realizedVolBlend: 0.616, realizedVol20: 0.55, vrp20: "rich", vrpRatio20: 1.21, macdLine: 4.2, macdSignal: 3.1, macdHistogram: 1.1, callWall: 320.0, putWall: 290.0, beta: 1.88, ytdPct: 0.338, listedThisYear: false },
    { ticker: "PANW", company: "Palo Alto Networks Inc", sector: "Cybersecurity", category: "wheel", source: "manual", dayChangePct: -0.0146, currentPrice: 333.26, bollingerUpper: 355.0, bollingerMid: 320.0, bollingerLower: 285.0, rsi14: 44.1, ivRank: null, ivRankSamples: 3, vrp: "n/a", vrpRatio: null, tier: "", atmIV: null, ivAsOf: "", realizedVolBlend: 0.412, realizedVol20: 0.36, vrp20: "n/a", vrpRatio20: null, macdLine: -1.2, macdSignal: -0.6, macdHistogram: -0.6, callWall: null, putWall: null, beta: null, ytdPct: -0.047, listedThisYear: false },
  ];
}
  ...
  leaps: {
    trades: [
      ...
      },
      {
        ...
        vixRegime: "Fear", ivRankAtOpen: 62, pccAtOpen: 0.85, pccAtClose: 0.80,
        // Acted the same day the alert fired -- still a loss, illustrating
        // that a fast response doesn't guarantee a win.
        pccAlertResponse: { action: "pcc_caution", firedAt: isoDay(-13), hoursToClose: 18 },
        guidelines: { leapDte: false, leapDelta: true },
      },
    ],
    guidelines: [
