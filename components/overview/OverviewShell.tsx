...
const HEADINGS: Record<Tab, { title: string; subtitle: string }> = {
  ...
  "bot-aggressive": {
    ...
    subtitle: "A short-dated CSP band (3–14 DTE, ≤0.28 delta, 80%+ ARR required) — also a real suggestion now, not just paperbot.",
  },
  chart: {
