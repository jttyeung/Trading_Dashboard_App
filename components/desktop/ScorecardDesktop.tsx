...
// the score-factor scorecard side by side. Moved here from a phone
// /scorecard page (since removed — it had become a strict subset of this
// tab) per the account holder's own call: the factor section is a
// sit-down review that wants width (a sparkline beside its numbers, not
// under them) and belongs next to the three bot tables whose picks it
// grades.
